...
test("todos los handlers administrativos sensibles autorizan OWNER en servidor", () => {
  const routeFiles = [
    ...
    "app/admin/merchandise/manage/route.ts",
    "app/admin/merchandise/manage/[id]/route.ts",
    "app/admin/merchandise/manage/[id]/status/route.ts",
